...
const MASK_VIEW_HEIGHT = WINDOW_HEIGHT - ((WINDOW_WIDTH - 40) * 0.63) - (WINDOW_HEIGHT * 0.4);
    ...
    if (!isReviewMode) {
      return (
        <View style={styles.cameraContentReview}>
          ...
          <View style={[styles.sidebar, { top: MASK_VIEW_HEIGHT, left: 0 }]} />
          <View style={[styles.sidebar, { top: MASK_VIEW_HEIGHT, right: 0 }]} />
      ...
      <View style={styles.container}>
        ...
        >
          <SimpleViewEditor
            imageWidth={width}
            imageHeight={height}
            style={[styles.viewEditor, { marginRight: 20 }]}
            // imageContainerWidth={WINDOW_WIDTH - 40}
            imageContainerHeight={(WINDOW_WIDTH - 40) * 0.63}
            initialOffsetY={-1 * MASK_VIEW_HEIGHT}
            initialOffsetX={-20}
            maskWidth={WINDOW_WIDTH - 40}
            panning={false}
            rotate={false}
          >
            <Image
  ...
  render() {
    ...
    return (
      <View style={styles.container}>
        ...
        <View style={[styles.image, { top: MASK_VIEW_HEIGHT }]}>
          <Image
            source={require('img/images/card_border.png')}
            style={[styles.image,
              {
                top: 0,
                resizeMode: 'stretch',
