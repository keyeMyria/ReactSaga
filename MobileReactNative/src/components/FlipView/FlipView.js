...
export class FlipView extends Component {
  ...
  flip = () => {
    ...
    let animations = [
      this._animateValue(this.state.frontRotationAnimatedValue,
        frontRotation, this.props.flipEasing),
      this._animateValue(this.state.backRotationAnimatedValue,
        backRotation, this.props.flipEasing)
    ];

    if (Platform.OS === 'android') {
      animations = [
        ...animations,
        this._animateValue(this.state.frontOpacityAnimatedValue,
          frontOpacity, this.props.flipEasing, 100),
        this._animateValue(this.state.backOpacityAnimatedValue,
          backOpacity, this.props.flipEasing, 100)
      ];
    }
