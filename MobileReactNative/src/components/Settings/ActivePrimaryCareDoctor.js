...
export class ActivePrimaryCareDoctor extends PureComponent {
  render() {
    const { provider, onProviderSelect, onPressDeleteProvider } = this.props;
    const swipeBtns = [
      {
        component: (
          <View
...
ActivePrimaryCareDoctor.defaultProps = {
  avatar: null,
  region: null,
  selectedProviders: [],
};
