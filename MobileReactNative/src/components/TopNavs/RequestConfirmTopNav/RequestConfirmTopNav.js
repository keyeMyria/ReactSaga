...
export class RequestConfirmTopNav extends PureComponent {
  ...
  render() {
    ...
    return (
      <View style={styles.container}>
        ...
        >
          <SFRegular style={styles.navButtonLabel}>{I18n.t('cancel')}</SFRegular>
        </TouchableOpacity>
        <View>
          {activePatient &&
        ...
        <TouchableOpacity
          ...
          hitSlop={{ left: 5, right: 5, top: 5, bottom: 5 }}
        >
          <SFRegular style={styles.navButtonLabel}>{I18n.t('done')}</SFRegular>
        </TouchableOpacity>
      </View>
    );
  }
...
RequestConfirmTopNav.propTypes = {
...
RequestConfirmTopNav.defaultProps = {
  activePatient: {},
  onBack: () => {},
  onDone: () => {},
  onExpanded: () => {},
